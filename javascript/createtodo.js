...
window.addEventListener("DOMContentLoaded",function(){
    document.getElementById("createTodoButton").addEventListener("click",createToDo);
...
function validatetodoform(new_todo){
    ...
    if(isReminder=='yes'){
        if(!new_todo.reminderDate){
            ...
            isFormValid=false;
            document.getElementById("reminderdate_err").innerHTML="Reminder date must be gratter than or equal start date";
        }
    }
